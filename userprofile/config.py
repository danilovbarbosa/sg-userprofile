...
SQLALCHEMY_DATABASE_URI = "postgresql://userprofile:userprofile@localhost/userprofile"
...
SQLALCHEMY_DATABASE_URI_TEST = "postgresql://userprofile:userprofile@localhost/userprofile_test"
